# TODO
* Label toolbar and add Settings icon that opens a popup
...
* Highlighter icon for marking annotated citations on WT side
* Split up content.js into smaller chunks
* For multi-box annotations, only display the edit toolbar on the box that was selected (but corner handles should be on all boxes)
* Increase box border width by 1px on mouse-over
